              ...
              <div>
                {KEY_AREAS.map((area, i) => (
                  <div key={i}>
                    ...
                    <div className="flex items-start gap-3 md:gap-5 py-4 md:py-5 lg:py-6">
                      ...
                      <p className="font-sans text-primary text-base sm:text-lg md:text-xl lg:text-2xl xl:text-[26px] tracking-[-0.04em] leading-[1.2] pt-1 md:pt-1.5 lg:pt-2">
                        {area}
                      </p>
                    </div>
                  </div>
