...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    shortProblem: "Reservation payments relied on manual coordination between reception and accounting teams, creating delays, inefficiencies, and a higher risk of human error.",
